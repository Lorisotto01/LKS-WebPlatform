...
/** Tab Release: pubblicazione di una nuova release + albero di versioning. */
export function ReleaseTab() {
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-2">
      ...
      {/* DX — Version tree */}
      <section>
        <h2 className="mb-3 text-lg font-semibold">Albero di versioning</h2>
        {releases.length === 0 ? (
